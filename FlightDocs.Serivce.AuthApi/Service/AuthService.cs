...
namespace FlightDocs.Serivce.AuthApi.Service
{
    public class AuthService : IAuthService 
    {
        ...
        public AuthService(AppDbContext db, IUserValidator userValidator,
       UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IJwtTokenGenerator jwtTokenGenerator)
        ...
        public Task<FluentValidation.Results.ValidationResult> ValidateEmailAsync(RegistrationRequestDto vm)
        {
            return _userValidator.RegistrationRequestValidator.ValidateAsync(vm);
        }
    }
}
